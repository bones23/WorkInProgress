...
public class PoliceEncounters extends Application {
    private Rectangle health1, health2, health3, health4;
    private Canvas canvas;
    private boolean myTurn = true;
    private Button attack, shield, leave, special, bribe;
    ...
    private ImageView ship_1, police_Ship, blackHole;
    ...
    public void start(final Stage primaryStage) {
        ...
        policeLabel = new Label("Unknown Police");
        policeLabel.setLayoutX(520);
        policeLabel.setLayoutY(43);
        policeLabel.setTextFill(Color.WHITE);
        ...
        health4 = new Rectangle(585, 75, police.getHealth(), rec_height);
        ...
        bribe = new Button("Bribe");
        bribe.setLayoutX(527);
        bribe.setLayoutY(321);
        ...
        root.getChildren().add(policeLabel);
        root.getChildren().add(shields);
        root.getChildren().add(bribe);
    ...
    private void attack(final Scene scene) {
        ...
        tl.setOnFinished(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                health4.setWidth(police.takeDamage(player.doDamage()));
                healthLabel2.setText("Health: " + police.getHealth() + "/100");
        ...
        tl.setOnFinished(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if (reverse) {
                    ...
                    if (police.getHealth() == 0 && player.getHealth() > 0) {    
                        leave.setVisible(true);
                        attack.setVisible(false);
                        shield.setVisible(false);
                        bribe.setVisible(false);
                    ...
                    health2.setWidth(player.takeDamage(police.doDamage()));
                    healthLabel1.setText("Health: " + player.getHealth() + "/100");
    ...
    public void explosion(String death) {
        if (death.equals("Player")) {
            ...
            canvas.toBack();
        } else if (death.equals("Police")) {
            police_Ship.setImage(explosion);
            canvas.toBack();
        }
    ...
    public void startingAnimation(final Scene scene) {
        ...
        police_Ship = new ImageView(policeShip);
        police_Ship.setLayoutX(960);
        police_Ship.setLayoutY(158);
        root.getChildren().add(police_Ship);
        Timeline tl1 = new Timeline();
        tl1.setCycleCount(1);
        KeyValue kv2 = new KeyValue(police_Ship.xProperty(), -260);
    ...
    public void startSwayPirate() {
        ...
        tl.setCycleCount(Timeline.INDEFINITE);
        tl.setAutoReverse(true);
        KeyValue kv = new KeyValue(police_Ship.xProperty(), -262);
        KeyValue kv1 = new KeyValue(police_Ship.yProperty(), 2);
        KeyFrame kf = new KeyFrame(Duration.millis(1500), kv, kv1);
        tl.getKeyFrames().add(kf);
        tl.play();
    }
    ...
    private void blackHole() {
        ...
        TranslateTransition translateTransition =
            new TranslateTransition(Duration.millis(2000), police_Ship);
        translateTransition.setToX(-95);
        translateTransition.setToY(-40);
        RotateTransition rotateTransition = 
            new RotateTransition(Duration.millis(2000), police_Ship);
        rotateTransition.setByAngle(180f);
        rotateTransition.setCycleCount(1);
        ScaleTransition scaleTransition = 
            new ScaleTransition(Duration.millis(2000), police_Ship);
